...
|-------------------------------------------------------------|
|                                                             |
|    ____           _    __   _     ____     ___    _____     |
|   |  _ \   _ __  (_)  / _| | |_  | __ )   / _ \  |_   _|    |
|   | | | | | '__| | | | |_  | __| |  _ \  | | | |   | |      |
|   | |_| | | |    | | |  _| | |_  | |_) | | |_| |   | |      |
|   |____/  |_|    |_| |_|    \__| |____/   \___/    |_|      |                                                      
|                                                             |
|-------------------------------------------------------------|                                                                                                              
"""
...
print(f'\n A free lobbybot network, created by Ikonik.Leaks#9483 and ICE#2965 for Patch {patch}.\n')
...
async def event_party_invite(invite):
    if data['joinoninvite'].lower() == 'true':
        try:
            ...
            pass
    elif data['joinoninvite'].lower() == 'true':
